...
class HomePage extends Page {
	...
	// Some defaults
    private static $allowed_children = array('SectionHolder', 'TenderHolder', 'EventHolder', 'MiniSection', 'GalleryPage', 'SectionPage', 'CityBylawsPage', 'MapsPage', 'AddressBook', 'DownloadsPage', 'RedirectorPage', 'RedirectorExtendedPage', 'EpaymentsRedirectorPage', 'BlogNewsHolder', 'CountyLawsHolder');
